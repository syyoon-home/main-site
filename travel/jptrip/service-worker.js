/*
  일본 여행 필수 회화 — Service Worker
  - Network First 전략: 최신 콘텐츠를 우선 시도하고, 실패(오프라인)하면 캐시로 대체합니다.
  - 광고 스크립트(Google AdSense 등)는 절대 가로채거나 캐싱하지 않고 네트워크로 그대로 통과시킵니다.
*/
const CACHE_NAME = "sy-jptrip-v1";
const PRECACHE_URLS = ["./", "./index.html", "./style.css", "./script.js", "./data.js", "./accommodation.html", "./cafe.html", "./directions.html", "./emergency.html", "./restaurant.html", "./shop.html", "./shopping.html", "./transport.html"];
